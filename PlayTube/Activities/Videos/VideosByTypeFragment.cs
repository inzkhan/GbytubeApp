        ...
        private void GetVideoByType()
        {
            try
            {
                ...
                else if (TypeVideo.Contains("Live"))
                {
                    ...
                    if (checkList != null)
                    {
                        MAdapter.VideoList = new ObservableCollection<VideoObject>(checkList.LiveVideoList);
        ...
        private async Task LoadDataAsync( string topOffset = "0", string latestOffset = "0", string favOffset = "0", string liveOffset = "0")
        {
            ...
            if (Methods.CheckConnectivity())
            {
                ...
                else
                {
                    ...
                    {
                        result.DataResult.Live = AppTools.ListFilter(new List<VideoObject>(result.DataResult.Live));
                    ...
                    { 
                        ...
                        else
                        {
                            ...
                            {
                                MAdapter.VideoList = new ObservableCollection<VideoObject>(result.DataResult.Live);
                            }
